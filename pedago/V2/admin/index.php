<html>
	<head>
		...
		<script type="text/javascript" src='../assets/js/visuel-onglet.js'></script>	
	</head>
	<body>
	<?php
	...
	if(isset($_GET['p']))
		{
			if($_SESSION['user_level']=='administrateur' || $_SESSION['user_level']=='professeur' || $_SESSION['user_level']=='developpeur')
			{
				...
				echo"
					...
					echo"</div>
						...
						<h3><i class='fa fa-file-pdf-o' aria-hidden='true'></i> Gestion des Cours<div class='button3'><i class='fa fa-arrow-circle-o-down' aria-hidden='true'></i></div></h3> 
							<div class='show_3'>
								<a href='index.php?p=a_chapitre'><span"; //Modif
								if($_GET['p']=='a_chapitre')  			//Modif
								{
									echo" class=active";  				//Modif
								}
							echo"> Ajouter un chapitre</span>
								<a href='index.php?p=a_cours'><span";  //Modif
								if($_GET['p']=='a_cours')
								{
									echo" class=active";
								}
							...
							<a href='index.php?p=liste_chapitre'><span";
								if($_GET['p']=='liste_chapitre')
								{
									echo" class=active";
								}
							echo"> Liste des chapitres</span></a>
						...
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Création  de la page terminée<p>
										...
										<form method='POST' action='index.php?p=g_onglet' enctype='multipart/form-data'>
											...
											<h4><i class='fa fa-paint-brush' aria-hidden='true'></i> Création de l'onglet : </h4>
												<div class='visuel'>
													Visuel : 
													<hr color=#000>
													<div class='link' id='onglet_color'>
												...
												<input type='color' name='color' id='couleur' onchange='visuel_color();' required><p>
												<span> Image : </span><p>
							...
							if(isset($_GET['cat'])&& $_GET['cat']=='edit')
							{
								...
								if(isset($valider))
								{
									...
									echo"
										<div class='panel'>
											<div class='form'>
												<center>Modification des informations pour l'utilisateur $user terminée.</center><p>
							...
							if(isset($_GET['cat'])&& $_GET['cat']=='update_mdp')
							{
								...
								if(isset($valider))
								{
									...
									echo"
										<div class='panel'>
											<div class='form'>
												<center>Modification du mot de passe pour l'utilisateur $user terminée.</center><p>
												<center><a href='index.php?p=account'><input type='button' class='return' value='Retour' ></a></center>
											</div>
											</form>
										</div>";
						...
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Ajout du logiciel terminé, vous pouvez retourner à l'accueil ou bien crée un nouveau cour.<p>
				...
				if($_GET['p']=='a_cours')
				{
					...
					if(isset($valider))
					{
						$position=stripos($chapitre_classe,'£');
						$classe=substr($chapitre_classe,($position+2));
						$chapitre=substr($chapitre_classe,0,$position);
						$check=create_cours($title,$chapitre,$file,$classe);
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Ajout du cours terminé, vous pouvez retourner à l'accueil ou bien crée un nouveau cour.<p>
										<input type='button' class='return' value='Annuler' onClick='history.back()'>
									</div>
								</div>";
						}
									...
									<div class='tips'>
										...
										<form method='POST' action='index.php?p=a_cours' enctype='multipart/form-data'>
											...
											<h4><i class='fa fa-file-pdf-o' aria-hidden='true'></i> Nouveau cours : </h4>
												<span> Titre : </span><p>
												<input type='text' name='title' required><p>
												<span>Chapitre : </span><p>
												<select name='chapitre_classe'>";
													formSelect_chapitre();
												echo"</select><p>
												<span> Cours : </span><p>
				...
				if($_GET['p']=='a_chapitre') //modif
				{
					...
					if(isset($valider))
					{
						$check=create_chapitre($title,$class);
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Ajout du chapitre terminé, vous pouvez retourner à l'accueil ou bien crée un nouveau chapitre.<p>
										<input type='button' class='return' value='Annuler' onClick='history.back()'>
									</div>
								</div>";
						}
						else
						{
							echo"
								<div class='message'>
									<h3>Echec</h3>
									<div class='info'>
										Création du chapitre impossible, veuillez vérifier vos informations.<p>
										<input type='button' class='return' value='Retour' onClick='history.back()'>
									</div>
								</div>";
						}
							...
							<div id='p_gestion'>
								...
								<div class='panel'>
									...
									<div class='tips'>
										<img src='../assets/img/help_icone.png'>
										<div class='info'>
											Grâce à cette page vous allez pouvoir ajouter un chapitre pour une classe bien précise.
										</div>
									</div><br>
										<form method='POST' action='index.php?p=a_chapitre' enctype='multipart/form-data'>
											<div class='form'>
						...
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Ajout du fichier ressource terminé, vous pouvez retourner à l'accueil ou bien ajouter un nouveau fichier.<p>
										<input type='button' class='return' value='Annuler' onClick='history.back()'>
									</div>
								</div>";
						}
							...
							<div id='p_gestion'>
								...
								<div class='panel'>
									...
									<div class='tips'>
										<img src='../assets/img/help_icone.png'>
										<div class='info'>
											Ici, vous allez pouvoir ajouter des fichiers ressources pour chaque classe.
										</div>
									</div><br>
					...
					if(isset($valider))
					{
						...
						<div id='home'>
							...
							<div class='message'>
								<h3>Réussie</h3>
								<div class='info'>
									Suppression terminée avec succès.<p>
									<input type='button' class='return' value='Retour' onClick='history.back()'>
								</div>
							</div>
						</div>";
				...
				if($_GET['p']=='liste_ressources')
				{
					...
					echo"<div id='home'>
							...
							<div id='listing'>
									<div class='panel'>
										<h3><i class='fa fa-list' aria-hidden='true'></i> Tous les ressources </h3>
				...
				if($_GET['p']=='liste_chapitre')
				{
					...
					echo"<div id='home'>
							...
							<div id='listing'>
									<div class='panel'>
										<h3><i class='fa fa-list' aria-hidden='true'></i> Toutes les chapitres </h3>
										<form method='POST' action='index.php?p=liste_chapitre'>";									
										liste_chapitre();
									echo"	<center><input type='submit' value='Supprimer sélection' name='valider' class='submit'></center>
										</form>
									</div>
				...
				if($_GET['p']=='liste_onglets')
				{
					...
					echo"<div id='home'>
							...
							<div id='listing'>
									<div class='panel'>
										<h3><i class='fa fa-list' aria-hidden='true'></i> Tous les onglets </h3>
				...
				if($_GET['p']=='del'&& isset($_GET['id']))
				{
					...
					echo"<div id='home'>
							...
							<div class='message'>
								...
								<form method='POST'>
									<div class='info'>
										Suppresion du compte <font color='#6a54b0'>$pseudo</font> terminée.<p>
				...
				if($_GET['p']=='actualite')
				{
					...
					if(isset($valider))
					{
						$check=add_news($title,$information,$date_debut,$date_fin);
						if($check=='true')
						{
							echo"
								<div class='message'>
									<h3>Réussie</h3>
									<div class='info'>
										Ajout de l'actualité terminé.<p>
										<input type='button' class='return' value='Retour' onClick='history.back()'>
									</div>
								</div>";
						}
				...
				<form method='POST' action='index.php'>
					<div class='login'>
						...
						<div class='panel'>
							...
							<a class='mdp_oublier' href='http://www.tspro.fr/technopro/forget.php'>Mot de passe oublié</a>
